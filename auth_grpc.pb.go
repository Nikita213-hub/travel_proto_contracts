...
func (c *authServiceClient) GenToken(ctx context.Context, in *GenTokenReq, opts ...grpc.CallOption) (*GenTokenRes, error) {
...
func (UnimplementedAuthServiceServer) GenToken(context.Context, *GenTokenReq) (*GenTokenRes, error) {
...
func _AuthService_GenToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GenToken(ctx, req.(*GenTokenReq))
	}
